...
@Service
@Profile("dev")
public class DevFileSystemStorageServiceImpl implements StorageService {
    ...
    @Autowired
    public DevFileSystemStorageServiceImpl(StorageProperties properties) {
        ...
        try {
            ...
            filesInDirectory.forEach(file -> {
                ...
                try {
                    ...
                    mimeType = "";
                    java.util.logging.Logger.getLogger(DevFileSystemStorageServiceImpl.class.getName()).log(Level.SEVERE, null, ex);
                }
            });
        } catch (IOException e) {
            throw new StorageException("Failed to read stored files", e);
