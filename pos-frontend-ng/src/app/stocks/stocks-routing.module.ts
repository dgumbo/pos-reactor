...
const routes: Routes = [
  ...
  { path: 'stock-receive/preview/:stockReceivePreviewId', component: StockReceiveComponent },
  { path: 'stock-receive/finalize/:stockReceiveFinalizeId', component: StockReceiveComponent },
