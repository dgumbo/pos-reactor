...
@Data
@Table
public class StockItemNegativeStockSell extends BaseEntity { 
    ...
    public String toString() {
        return this.getClass().getName() + " {" + "id=" + id + ", stockItem=" + stockItem +", allow=" + allow + ", activeStatus=" + activeStatus + '}';
    } 
