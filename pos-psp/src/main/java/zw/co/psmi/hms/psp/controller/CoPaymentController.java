...
public class CoPaymentController {
    ...
    @RequestMapping(value = "/psp/copaymentwindow", method = RequestMethod.GET)
    public String drugpreparationwindow(@AuthenticationPrincipal UserLogin userLogin, Model model, @ModelAttribute Quotation quotation) {
        ...
        model.addAttribute("copayments", pspServiceChargeService.getActiveAndServiceClassAndUnit(ServiceClass.CO_PAYMENT, unit.getId()));
        return "psp/copayment";
    }
}
