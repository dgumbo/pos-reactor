...
import zw.co.hisolutions.pos.dayend.service.*;
 ...
 */
@Service
public class DayendCashRegisterServiceImpl implements DayendCashRegisterService{

    @Autowired
    DayendCashRegisterViewDao dayendCashRegisterViewDao;
    ...
    private List<DayendCashRegisterView> getDeclaredAmount(String unitCode, String user, Date fromDate, Date endDate) {
        ...
        List<DayendCashRegisterView> receiptedAmount = dayendCashRegisterViewDao.getReceiptedAmountData(   fromDate, endDate);
        ...
        for (DayendCashRegisterView colData : reportData) {
            ...
            for (Field field : DayendCashRegisterView.class.getDeclaredFields()) {
                ...
                try {
                    ...
                    Logger.getLogger(DayendCashRegisterServiceImpl.class.getName()).log(Level.SEVERE, null, ex);
                }
